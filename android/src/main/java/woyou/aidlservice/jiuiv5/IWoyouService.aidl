...
{	
  ...
  * black mark mode: 2
  ...
  /** Added by Jimmy 11/12/2021
  * called before every new content to locate the next label
  *
  */
  void labelLocate();

  /** Added by Jimmy 11/12/2021
  * called after all labels that need to be printed are called to actually print the labels
  *
  */
  void labelOutput();
